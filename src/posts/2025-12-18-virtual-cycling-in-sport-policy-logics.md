...
title: "Virtual Cycling in Sports Clubs: how does that fit in existing sport policy?"
date: 2025-12-18T15:34:54.000Z
excerpt: How is virtual cycling thought of by clubs? And how does that fit into existing sport policy?
author: thibault-fouquaert
draft: false
seo: # SEO values are used for OG and will overwrite 'title' and 'excerpt' above
  title:
  description:
  image: /2025/12/banner-logics-virtual-cyling.webp # used for OG:image and Twitter:image. Overrides default set in _data/meta.siteImage
images: # relative to /src/assets/images/ eg. /20225/05/img.webp
  feature: /2025/12/banner-logics-virtual-cyling.webp
  thumb: /2025/12/banner-logics-virtual-cyling.webp
...
{% wrap "md:w-2/3 mx-auto" %} 
![Clubs clustered along three perceived benefits and goals for the club](/assets/images/2025/12/graph-goals-archetypes-virtual-cycling.webp)
{% endwrap %}
