...
slug: lucas-gobeler
name: Lucas Göbeler
date: 2025-12-17T11:50:02.000Z
image: 'members/lucas-gobeler.webp'
seo:
  image: 'members/lucas-gobeler.webp'
email: lucas.goebeler@uni-hamburg.de
university: University of Hamburg
department: UHH Business School
researchGroup: Chair of Information Systems and Digital Innovation
jobTitle: Post Doctoral Researcher
bioShort: Lucas' research examines the digitalization of traditional sports, the health implications of born-digital sports, and the role of physicality in a digital innovation context.
bioLong: 
groupWebsite:
  label: Website the Nucleus Professorship for Information Systems and Digital Innovation
  url: https://www.bwl.uni-hamburg.de/en/isdi/mitarbeiterverzeichnis/goebeler.html
departmentWebsite:
  label: UHH Business School Website
  url: https://www.bwl.uni-hamburg.de/en.html
universityWebsite:
  label: University Of Hamburg Website
  url: https://www.uni-hamburg.de/en.html
personalWebsites:
- label: Profile UHH page Lucas Göbeler
  url: https://www.bwl.uni-hamburg.de/en/isdi/mitarbeiterverzeichnis/goebeler.html
socialWebsites:
- label: orcid
  url: ''
- label: researchgate
  url: 
- label: linkedin
  url: 'https://www.linkedin.com/in/lucas-goebeler/'
- label: googlescholar
  url: 'https://scholar.google.com/citations?user=7P-P8IkAAAAJ'
- label: X
  url: ''
- label: github
  url: ''
