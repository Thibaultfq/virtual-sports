 ...
 */
    ...
    getMostRecentPage: (pages) => {
      // returns most recent page from array of pages such as posts or members
      if (!Array.isArray(pages) || pages.length === 0) {
        console.warn('no posts array provided')
        return null
      }
      return pages.reduce((acc, curr, index) => (curr.page.date > acc.page.date && index ? curr : acc))
      //.data.date
    },
